...
public class EmpWageCompMulti
{
	...
	static int getWorkingHrs(int wHr)
	{
		int workingHrs;
		switch(wHr)
		{
	...
	public EmpWageCompMulti(int numberOfCompany)
	{
	...
	public static void main(String[] args)
	{
		...
		EmpWageCompMulti obj=new EmpWageCompMulti(numberOfCompany);
	}
}
